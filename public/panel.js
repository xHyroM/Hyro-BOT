...
var config = require("../config.json")
   const Discord = require("discord.js")
    ...
    const lastMessages = $("#lastMessages");
              ...
              //serverCount.html(serverCount.html() + `<h1>Test</h1>`);
              //localStorage.setItem("serverCount", $("serverCount").html());
       //$("#serverCount").html(getSavedValue("serverCount"))
...
function botUptime(){
  ...
  if(message.guild.name === 'The Developers' || message.guild.name === "» HYRO 🎉 SERVER «") {    
